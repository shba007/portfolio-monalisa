...
<template>
  ...
  <section id="hero"
    ...
    <div
      class="justify-self-center row-start-1 row-span-5 md:row-span-full col-start-1 md:col-start-2 col-span-full md:col-span-3 flex flex-col justify-center items-center gap-3 md:gap-4 text-center z-10 -translate-y-[15%]">
      ...
      <button
        class="sm:my-2 border-2 md:border-4 border-primary-400 rounded-full px-[1.125rem] sm:px-7 py-1 sm:py-3 text-white sm:text-lg tracking-wide leading-9 bg-primary-500 hover:bg-primary-400 transition-colors">
        Get Appointment
      </button>
    </div>
    <div
