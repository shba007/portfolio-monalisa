...
<template>
  <ModelBase :is-open="isOpen" @close="close"
    ...
    <NuxtLink v-for="{ method, icon, link } of methods" :key="method" :to="link" target="__blank" :aria-label="method" @click="contact(method)"
      class="flex flex-col items-center justify-center gap-3 px-9 pt-6 text-white aspect-square cursor-pointer transition-colors"
